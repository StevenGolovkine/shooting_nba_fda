...
\begin{figure}
	\centering
	\includegraphics[scale=0.55]{figures/confusion_mat_kmedoids_no_weights.eps}
	\hfill
	\includegraphics[scale=0.55]{figures/confusion_mat_kmedoids_weights.eps}
	\hfill
	\includegraphics[scale=0.55]{figures/confusion_matk_medoids_w_no_w.eps}
...
\begin{figure}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[scale=0.2]{figures/kmedoids_1_eigenfunction_1.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_1_eigenfunction_2.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_1_eigenfunction_3.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_1_eigenfunction_4.eps}
		\caption{Cluster 1.}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[scale=0.2]{figures/kmedoids_2_eigenfunction_1.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_2_eigenfunction_2.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_2_eigenfunction_3.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_2_eigenfunction_4.eps}
		\caption{Cluster 2}
	\end{subfigure}
	\\
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[scale=0.2]{figures/kmedoids_3_eigenfunction_1.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_3_eigenfunction_2.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_3_eigenfunction_3.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_3_eigenfunction_4.eps}
		\caption{Cluster 3.}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[scale=0.2]{figures/kmedoids_4_eigenfunction_1.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_4_eigenfunction_2.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_4_eigenfunction_3.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_4_eigenfunction_4.eps}
		\caption{Cluster 4}
	\end{subfigure}
	\\
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[scale=0.2]{figures/kmedoids_5_eigenfunction_1.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_5_eigenfunction_2.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_5_eigenfunction_3.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_5_eigenfunction_4.eps}
		\caption{Cluster 5}
	\end{subfigure}
	\caption{MFPCA decompositions from the clustering using equal weights for each component.
	}
...
\begin{figure}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_1_eigenfunction_1.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_1_eigenfunction_2.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_1_eigenfunction_3.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_1_eigenfunction_4.eps}
		\caption{Cluster 1.}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_2_eigenfunction_1.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_2_eigenfunction_2.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_2_eigenfunction_3.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_2_eigenfunction_4.eps}
		\caption{Cluster 2}
	\end{subfigure}
	\\
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_3_eigenfunction_1.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_3_eigenfunction_2.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_3_eigenfunction_3.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_3_eigenfunction_4.eps}
		\caption{Cluster 3.}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_4_eigenfunction_1.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_4_eigenfunction_2.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_4_eigenfunction_3.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_4_eigenfunction_4.eps}
		\caption{Cluster 4}
	\end{subfigure}
	\\
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_5_eigenfunction_1.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_5_eigenfunction_2.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_5_eigenfunction_3.eps}
		\includegraphics[scale=0.2]{figures/kmedoids_weighted_5_eigenfunction_4.eps}
		\caption{Cluster 5}
	\end{subfigure}
	\caption{MFPCA decompositions from the clustering using variance weights for each component.}
