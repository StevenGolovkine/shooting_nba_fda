...
{\color{blue}Densities are computed separately for each shot type (made and missed) and each player and are therefore normalized for each individuals total number of each shots.
...
\end{equation}
where $\mu(s, t)$ is the mean (average) function, and $c_k$ are the player-specific basis coefficients, referred to as scores. Each eigenfunction in the decomposition~\eqref{eq:kl_decomp} {\color{blue} characterizes} a variation away from the mean function, with the player-specific scores indicating the magnitude and direction of the deviation for each individual player. We estimate four components ($K = 4$), based on the approach of \cite{golovkineUseGramMatrix2024}, explaining approximately $90\%$ of the total variance in the data. The scores $c_k$ are estimated as the projection of the observations $X$ onto the eigenfunctions $\phi_k$ \textcolor{blue}{using the inner product in $\mathcal{H}$}. These scores provide a finite-dimensional representation of the functional data, capturing player-specific characteristics, and can be used as scalar variables in subsequent analyses.
To create a data-driven taxonomy of players based on MFPCA, we apply a $k$-medoids clustering algorithm \citep{kaufmanFindingGroupsData2009} to the normalized functional principal component scores $c_k$, using $k = 5$ clusters, as the number of players on the court.
	{\color{blue}Moreover, we will compare the estimated clusters to the $k=5$ nominal positions provided by the NBA.
...
Finally, some limitations of the proposed modelling framework are as follows.
	{\color{blue}We employed standard FPCA which assumes that observations are realizations from an unconstrained space of functions.
...
\textcolor{blue}{As a sensitivity check, we performed the following exercise:
	\begin{itemize}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap0_mean.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap0_eigenfunction_1.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap0_eigenfunction_2.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap0_eigenfunction_3.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap0_eigenfunction_4.pdf}
	\\
	\includegraphics[scale=0.35]{figures/colorbar2.pdf}
	\caption{Bootstrap: First sample results.}
	\label{fig:boostrap_1}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap1_mean.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap1_eigenfunction_1.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap1_eigenfunction_2.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap1_eigenfunction_3.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap1_eigenfunction_4.pdf}
	\\
	\includegraphics[scale=0.35]{figures/colorbar2.pdf}
	\caption{Bootstrap: Second sample results.}
	\label{fig:boostrap_2}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap3_mean.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap3_eigenfunction_1.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap3_eigenfunction_2.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap3_eigenfunction_3.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap3_eigenfunction_4.pdf}
	\\
	\includegraphics[scale=0.35]{figures/colorbar2.pdf}
	\caption{Bootstrap: Third sample results.}
	\label{fig:boostrap_3}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap4_mean.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap4_eigenfunction_1.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap4_eigenfunction_2.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap4_eigenfunction_3.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap4_eigenfunction_4.pdf}
	\\
	\includegraphics[scale=0.35]{figures/colorbar2.pdf}
	\caption{Bootstrap: Fourth sample results.}
	\label{fig:boostrap_4}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap2_mean.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap2_eigenfunction_1.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap2_eigenfunction_2.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap2_eigenfunction_3.pdf}
	\includegraphics[scale=0.2]{figures/bootstrap/bootstrap2_eigenfunction_4.pdf}
	\\
	\includegraphics[scale=0.35]{figures/colorbar2.pdf}
	\caption{Bootstrap: Fifth sample results.}
