...
% \renewcommand*{\nameyeardelim}{\addcomma\space} % https://tex.stackexchange.com/questions/134063/how-te-add-a-comma-between-author-and-year
\usepackage{dsfont} % for fancy R
\AtEveryBibitem{%
  \clearfield{note}%
}
...
\title{\vspace{-1cm}
\begin{flushleft} {\sffamily \emph{``Is Stephen Curry really a guard? A new perspective on player typologies using functional data analysis''}: Reviewer Responses}\end{flushleft}}
\date{\vspace{-1.7cm}\begin{flushleft}\sffamily 
%Steven Golovkine and
%Edward Gunning.
\end{flushleft}}
...
\section*{General/ Overall Responses}

We thank the associate editor and the two reviewers for their thorough and detailed review of our manuscript.
We have addressed each review point by point, making appropriate changes in the revised manuscript.
As a result, we believe that the revised manuscript is greatly improved.
Responses to each of the reviewer's points are contained in the remainder of this document.
{\color{purple}We look forward to your final decision with anticipation.}
