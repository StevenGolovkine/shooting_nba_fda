...
\reply{
\begin{itemize}
    \item \textbf{Intensity surfaces}: mean number of shots expected per unit area. These are \emph{not} normalized. Players who play more games, or just shoot more in generalcan have different intensities despite having same underlying patterns.
...
\reply{
    ...
    Indeed, this interpretation was phrased incorrectly. We have now replaced this explanation with a correct interpretation, in terms of relative numbers of shots missed and shots made, rather than overall shooting volume.
