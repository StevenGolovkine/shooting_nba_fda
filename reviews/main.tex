...
\title{\vspace{-1cm}
\begin{flushleft} {\sffamily \emph{``Is Stephen Curry really a guard? New perspective on players typology using functional data analysis''}: Reviewer Responses}\end{flushleft}}
