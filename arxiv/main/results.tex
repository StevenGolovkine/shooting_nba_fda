...
\begin{figure}
    ...
    \caption{Most representative player of each cluster according to the $k$-medoids algorithm using an euclidean distance with weights defined using the percentage of variance explained by each components.}
...
\begin{figure}
    ...
    \caption{Agreement between the different clustering. NBA clusters are based on the usual typology ($0$: center, $1$: forward, $2$: forward-center, $3$: forward-guard, $4$: guard).}
