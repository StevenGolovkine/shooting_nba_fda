...
The estimated functional components can be understood as characterizing different shooting behaviours. We first note that, except for $\phi_3$, the functional components for missed and made shots are similar.
