...
\subsection{Outliers} % (fold)
\label{sub:outliers}

From Figure~\ref{fig:clusters}, we remark that some players exhibit scores (coefficients) that are very different than the other players. For example, for the second eigenfunction, ... (with a large coefficient) and ... (with a large negative coefficient) may be designed as outliers ... Similarly, for the third eigenfunction, ... has a large negative coefficient. Finally, for the fourth eigenfunction, ... has a large positive coefficient and ... has a large negative coefficient.

% subsection outliers (end)
