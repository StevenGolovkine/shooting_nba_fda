...
Our modeling framework could also be applied to positional data in other sports, for example, to characterize a player's typical position in soccer, or the ``fighting style" of a boxer.
