...
\textcolor{blue}{Here, we present the description of the different part of a basketball court that we refer in the text.}

\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{figures/court_description.pdf}
	\caption{Description of the court.}
...
\begin{figure}
	...
	\begin{subfigure}{0.49\textwidth}
		...
		\caption{Cluster 5}
	\end{subfigure}
	\caption{\textcolor{blue}{TO BE CHANGED: MFPCA decompositions from the clustering using equal weights for each component.}
	}
